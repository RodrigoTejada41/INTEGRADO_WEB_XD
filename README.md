...
- Acesso SSH operacional: [`infra/SSH_ACESSO.md`](infra/SSH_ACESSO.md)
...
- Deploy de dev: `.github/workflows/deploy-dev.yml`
- Variante manual self-hosted: `.github/workflows/deploy-prod-self-hosted.yml`
- Fluxo recomendado: mudanca local -> teste -> documentacao -> deploy para a VPS de `dev` -> validacao -> promocao para producao
