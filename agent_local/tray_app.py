...
class TrayController:
    ...
    def refresh(self) -> None:
        ...
        self.running = active
        self.status_text = "Movi_relatorios_sync ativo" if active else "Movi_relatorios_sync parado"
        if self.icon:
...
def main() -> int:
    ...
    try:
        ...
        print("Reinstale o pacote atualizado do Movi_relatorios_sync.")
        return 1
    TrayController().run()
    return 0
