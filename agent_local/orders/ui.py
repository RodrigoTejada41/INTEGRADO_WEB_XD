...
async function responseMessage(response) {
  ...
  try {
    ...
    if (data.detail === 'Local token invalid.') return 'Token local invalido. No servidor, abra por http://127.0.0.1:8767/orders/ui para preencher automaticamente. No celular, copie o token de ACESSO_REDE_LOCAL.txt.';
