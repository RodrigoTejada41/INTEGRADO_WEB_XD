-- Compatibility bridge for teams that expect database/schema.sql.
-- Canonical sources remain:
--   1. backend/sql/postgresql_schema.sql
--   2. infra/sql/schema.sql
--
-- This file mirrors the primary PostgreSQL sync tables without changing the
